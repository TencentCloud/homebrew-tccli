...
class TccliIntlEn < Formula
  ...
  url "https://github.com/TencentCloud/tencentcloud-cli-intl-en/archive/3.1.97.1.tar.gz"
  sha256 "e4b15109eba77be64f168052f987c85bdce0cd22a139793a5db4d9e86544ac0b"
  license "Apache-2.0"
